class CreateOhmInbox < ActiveRecord::Migration[6.1]
  def change
    ...
    create_table :ohm_inbox_completions do |t|
      ...
      t.references(
        ...
        null: false,
        foreign_key: {to_table: :ohm_inbox_messages},
        index: true
      )
      t.timestamps
      ...
      t.index(
        ...
        name: "index_ohm_inbox_completions_on_processor_message_type_key_uniq",
        unique: true
      )
      ...
      t.index(
        ...
        name: "index_ohm_inbox_completions_on_processor_message_completed"
      )
    end
  end
end
