...
# This is an autogenerated file for dynamic methods in `Coil::Inbox::MessagesPeriodicJob`.
# Please instead update this file by running `bin/tapioca dsl Coil::Inbox::MessagesPeriodicJob`.


class Coil::Inbox::MessagesPeriodicJob
  class << self
    sig { returns(String) }
