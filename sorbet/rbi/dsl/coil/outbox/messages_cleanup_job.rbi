...
# This is an autogenerated file for dynamic methods in `Coil::Outbox::MessagesCleanupJob`.
# Please instead update this file by running `bin/tapioca dsl Coil::Outbox::MessagesCleanupJob`.


class Coil::Outbox::MessagesCleanupJob
  class << self
