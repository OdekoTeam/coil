...
# This is an autogenerated file for dynamic methods in `Coil::TransactionalMessagesJob`.
# Please instead update this file by running `bin/tapioca dsl Coil::TransactionalMessagesJob`.
