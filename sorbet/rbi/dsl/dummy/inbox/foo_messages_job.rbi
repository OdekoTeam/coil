...
# This is an autogenerated file for dynamic methods in `Dummy::Inbox::FooMessagesJob`.
# Please instead update this file by running `bin/tapioca dsl Dummy::Inbox::FooMessagesJob`.


class Dummy::Inbox::FooMessagesJob
  class << self
