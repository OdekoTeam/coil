...
# This is an autogenerated file for dynamic methods in `Dummy::Inbox::WhoMessagesJob`.
# Please instead update this file by running `bin/tapioca dsl Dummy::Inbox::WhoMessagesJob`.


class Dummy::Inbox::WhoMessagesJob
  class << self
