...
# This is an autogenerated file for dynamic methods in `Dummy::Outbox::BarMessagesJob`.
# Please instead update this file by running `bin/tapioca dsl Dummy::Outbox::BarMessagesJob`.


class Dummy::Outbox::BarMessagesJob
  class << self
