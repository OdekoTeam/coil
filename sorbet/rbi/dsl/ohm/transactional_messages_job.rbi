...
# This is an autogenerated file for dynamic methods in `Ohm::TransactionalMessagesJob`.
# Please instead update this file by running `bin/tapioca dsl Ohm::TransactionalMessagesJob`.


class Ohm::TransactionalMessagesJob
  class << self
