...
class RBI::File
  ...
  # source://rbi//lib/rbi/rbs_printer.rb#1237
...
class RBI::Node
  ...
  # source://rbi//lib/rbi/rbs_printer.rb#1246
  sig do
    params(
      out: T.any(::IO, ::StringIO),
      indent: ::Integer,
  ...
  # source://rbi//lib/rbi/rbs_printer.rb#1252
...
class RBI::RBS::TypeTranslator
  class << self
    ...
    # source://rbi//lib/rbi/rbs/type_translator.rb#106
    ...
    # source://rbi//lib/rbi/rbs/type_translator.rb#161
    sig { params(type_name: ::String).returns(::String) }
    def translate_t_generic_type(type_name); end

    # source://rbi//lib/rbi/rbs/type_translator.rb#94
...
class RBI::Type
  ...
  # source://rbi//lib/rbi/type.rb#993
  sig { void }
  def initialize; end

  # source://rbi//lib/rbi/type.rb#1064
  sig { abstract.params(other: ::BasicObject).returns(T::Boolean) }
  def ==(other); end

  # source://rbi//lib/rbi/type.rb#1067
  sig { params(other: ::BasicObject).returns(T::Boolean) }
  def eql?(other); end

  # source://rbi//lib/rbi/type.rb#1073
  sig { override.returns(::Integer) }
  def hash; end

  # source://rbi//lib/rbi/type.rb#1007
  sig { returns(::RBI::Type) }
  def nilable; end

  # source://rbi//lib/rbi/type.rb#1034
  sig { returns(T::Boolean) }
  def nilable?; end
  ...
  # source://rbi//lib/rbi/type.rb#1048
  sig { abstract.returns(::RBI::Type) }
  def normalize; end

  # source://rbi//lib/rbi/rbs_printer.rb#1261
  sig { returns(::String) }
  def rbs_string; end

  # source://rbi//lib/rbi/type.rb#1060
  sig { abstract.returns(::RBI::Type) }
  def simplify; end

  # source://rbi//lib/rbi/type.rb#1079
  sig { abstract.returns(::String) }
  def to_rbi; end

  # source://rbi//lib/rbi/type.rb#1083
  sig { override.returns(::String) }
  def to_s; end

  class << self
    # source://rbi//lib/rbi/type.rb#929
    ...
    # source://rbi//lib/rbi/type.rb#860
    sig { returns(::RBI::Type::AttachedClass) }
    def attached_class; end

    # source://rbi//lib/rbi/type.rb#866
    ...
    # source://rbi//lib/rbi/type.rb#872
    ...
    # source://rbi//lib/rbi/type.rb#843
    sig { params(name: ::String).returns(::RBI::Type::Simple) }
    def simple(name); end

    # source://rbi//lib/rbi/type.rb#898
    ...
    # source://rbi//lib/rbi/type_parser.rb#244
    sig { params(node: ::Prism::CallNode).returns(::RBI::Type) }
    def parse_proc(node); end

    # source://rbi//lib/rbi/type_parser.rb#223
    sig { params(node: T.any(::Prism::HashNode, ::Prism::KeywordHashNode)).returns(::RBI::Type) }
    def parse_shape(node); end

    # source://rbi//lib/rbi/type_parser.rb#218
    sig { params(node: ::Prism::ArrayNode).returns(::RBI::Type) }
    def parse_tuple(node); end

    # source://rbi//lib/rbi/type_parser.rb#335
    sig { params(node: T.nilable(::Prism::Node)).returns(T::Boolean) }
    def t?(node); end

    # source://rbi//lib/rbi/type_parser.rb#354
    sig { params(node: T.nilable(::Prism::Node)).returns(T::Boolean) }
    def t_boolean?(node); end

    # source://rbi//lib/rbi/type_parser.rb#361
    sig { params(node: ::Prism::ConstantPathNode).returns(T::Boolean) }
    def t_class?(node); end

    # source://rbi//lib/rbi/type_parser.rb#371
    sig { params(node: T.nilable(::Prism::Node)).returns(T::Boolean) }
    def t_class_of?(node); end

    # source://rbi//lib/rbi/type_parser.rb#366
    sig { params(node: ::Prism::ConstantPathNode).returns(T::Boolean) }
    def t_module?(node); end

    # source://rbi//lib/rbi/type_parser.rb#378
    sig { params(node: ::Prism::CallNode).returns(T::Boolean) }
    def t_proc?(node); end

    # source://rbi//lib/rbi/type_parser.rb#347
    sig { params(node: T.nilable(::Prism::Node)).returns(T::Boolean) }
    def t_type_alias?(node); end

    # source://rbi//lib/rbi/type.rb#987
...
class RBI::Type::All < ::RBI::Type::Composite
  ...
  # source://rbi//lib/rbi/type.rb#449
  sig { override.returns(::RBI::Type) }
  def simplify; end

  # source://rbi//lib/rbi/type.rb#423
  sig { override.returns(::String) }
  def to_rbi; end
end

# source://rbi//lib/rbi/type.rb#462
class RBI::Type::Any < ::RBI::Type::Composite
  # source://rbi//lib/rbi/type.rb#470
  sig { returns(T::Boolean) }
  def nilable?; end

  # source://rbi//lib/rbi/type.rb#476
  sig { override.returns(::RBI::Type) }
  def normalize; end
  ...
  # source://rbi//lib/rbi/type.rb#465
  sig { override.returns(::String) }
  def to_rbi; end
end
...
class RBI::Type::ClassOf < ::RBI::Type
  ...
  # source://rbi//lib/rbi/type.rb#330
  sig { override.params(other: ::BasicObject).returns(T::Boolean) }
  def ==(other); end
  ...
  # source://rbi//lib/rbi/type.rb#319
...
class RBI::Type::Composite < ::RBI::Type
  ...
  # source://rbi//lib/rbi/type.rb#407
  sig { params(types: T::Array[::RBI::Type]).void }
  def initialize(types); end

  # source://rbi//lib/rbi/type.rb#414
  sig { override.params(other: ::BasicObject).returns(T::Boolean) }
  def ==(other); end

  # source://rbi//lib/rbi/type.rb#404
...
class RBI::Type::Generic < ::RBI::Type
  # source://rbi//lib/rbi/type.rb#555
  ...
  # source://rbi//lib/rbi/type.rb#549
  sig { returns(::String) }
  def name; end
  ...
  # source://rbi//lib/rbi/type.rb#552
  sig { returns(T::Array[::RBI::Type]) }
  def params; end
...
class RBI::Type::Module < ::RBI::Type
  ...
  # source://rbi//lib/rbi/type.rb#290
  sig { override.params(other: ::BasicObject).returns(T::Boolean) }
  def ==(other); end

  # source://rbi//lib/rbi/type.rb#302
  sig { override.returns(::RBI::Type) }
  def normalize; end
...
# source://rbi//lib/rbi/type.rb#358
class RBI::Type::Nilable < ::RBI::Type
  # source://rbi//lib/rbi/type.rb#363
  sig { params(type: ::RBI::Type).void }
  def initialize(type); end
...
class RBI::Type::Proc < ::RBI::Type
  # source://rbi//lib/rbi/type.rb#754
  sig { void }
  def initialize; end
  ...
  # source://rbi//lib/rbi/type.rb#791
  sig { params(type: T.untyped).returns(T.self_type) }
  def bind(type); end

  # source://rbi//lib/rbi/type.rb#823
  sig { override.returns(::RBI::Type) }
  def normalize; end

  # source://rbi//lib/rbi/type.rb#773
  sig { params(params: ::RBI::Type).returns(T.self_type) }
  def params(**params); end

  # source://rbi//lib/rbi/type.rb#751
  sig { returns(T.nilable(::RBI::Type)) }
  def proc_bind; end
  ...
  # source://rbi//lib/rbi/type.rb#779
  sig { params(type: T.untyped).returns(T.self_type) }
  def returns(type); end

  # source://rbi//lib/rbi/type.rb#829
  sig { override.returns(::RBI::Type) }
  def simplify; end
  ...
  # source://rbi//lib/rbi/type.rb#785
  sig { returns(T.self_type) }
  def void; end
end
...
# source://rbi//lib/rbi/type.rb#701
class RBI::Type::Shape < ::RBI::Type
  # source://rbi//lib/rbi/type.rb#706
  ...
  # source://rbi//lib/rbi/type.rb#729
  sig { override.returns(::RBI::Type) }
  def normalize; end

  # source://rbi//lib/rbi/type.rb#735
  sig { override.returns(::RBI::Type) }
  def simplify; end

  # source://rbi//lib/rbi/type.rb#719
  sig { override.returns(::String) }
  def to_rbi; end
...
# source://rbi//lib/rbi/type.rb#623
class RBI::Type::TypeAlias < ::RBI::Type
  ...
  # source://rbi//lib/rbi/type.rb#639
  sig { override.params(other: ::BasicObject).returns(T::Boolean) }
  def ==(other); end

  # source://rbi//lib/rbi/type.rb#628
  sig { returns(::RBI::Type) }
  ...
  # source://rbi//lib/rbi/type.rb#645
  sig { override.returns(::String) }
  def to_rbi; end
end
...
class RBI::Type::TypeParameter < ::RBI::Type
  ...
  # source://rbi//lib/rbi/type.rb#599
  sig { override.params(other: ::BasicObject).returns(T::Boolean) }
  def ==(other); end
  ...
  # source://rbi//lib/rbi/type.rb#611
  sig { override.returns(::RBI::Type) }
  def normalize; end

  # source://rbi//lib/rbi/type.rb#617
  sig { override.returns(::RBI::Type) }
  def simplify; end

  # source://rbi//lib/rbi/type.rb#605
  sig { override.returns(::String) }
  def to_rbi; end
end
...
class RBI::TypePrinter
  ...
  # source://rbi//lib/rbi/rbs_printer.rb#1062
  sig { params(type: ::RBI::Type::Anything).void }
  def visit_anything(type); end
  ...
  # source://rbi//lib/rbi/rbs_printer.rb#1189
  sig { params(type: ::RBI::Type::Class).void }
  def visit_class(type); end

  # source://rbi//lib/rbi/rbs_printer.rb#1105
  sig { params(type: ::RBI::Type::ClassOf).void }
  def visit_class_of(type); end

  # source://rbi//lib/rbi/rbs_printer.rb#1051
  sig { params(type: ::RBI::Type::Generic).void }
  def visit_generic(type); end
  ...
  # source://rbi//lib/rbi/rbs_printer.rb#1072
  sig { params(type: ::RBI::Type::NoReturn).void }
  def visit_no_return(type); end

  # source://rbi//lib/rbi/rbs_printer.rb#1162
  sig { params(type: ::RBI::Type::Proc).void }
  def visit_proc(type); end
  ...
  # source://rbi//lib/rbi/rbs_printer.rb#1041
  sig { params(type: ::RBI::Type::Simple).void }
  def visit_simple(type); end

  # source://rbi//lib/rbi/rbs_printer.rb#1132
  sig { params(type: ::RBI::Type::Tuple).void }
  def visit_tuple(type); end

  # source://rbi//lib/rbi/rbs_printer.rb#1184
  sig { params(type: ::RBI::Type::TypeParameter).void }
  def visit_type_parameter(type); end

  # source://rbi//lib/rbi/rbs_printer.rb#1077
  sig { params(type: ::RBI::Type::Untyped).void }
  def visit_untyped(type); end

  # source://rbi//lib/rbi/rbs_printer.rb#1067
  sig { params(type: ::RBI::Type::Void).void }
  def visit_void(type); end

  private

  # source://rbi//lib/rbi/rbs_printer.rb#1205
  sig { params(type_name: ::String).returns(::String) }
